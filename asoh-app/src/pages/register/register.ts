...
export class RegisterPage {
  ...
  constructor(public platform: Platform, public camera: Camera, public file: File, 
            public filePath: FilePath, public actionSheetCtrl: ActionSheetController, 
            public toastCtrl: ToastController, public afAuth: AngularFireAuth, public fb: FormBuilder, 
            public navCtrl: NavController, public navParams: NavParams,public loadingProvider: LoadingProvider,
  ...
  doRegister(regData){
      ...
      this.loadingProvider.startLoading();
        ...
        .then(result => {
          ...
          this.afDatabase.object('parents/' + result.uid).set({
